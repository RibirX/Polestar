...
use crate::{db::pool::DbPool, model::attachment::Attachment, error::PolestarError};
...
pub async fn query_attachment_by_name(pool: &DbPool, name: &Uuid) -> Result<Attachment, PolestarError> {
